...
reference_objects_dict = {
    ...
    'CPDistributedObjectInfo': 'aCPDistributedObjectInfo',
    'CPGroupId': 'aCPGroupId',
    ...
    'List_CPDistributedObjectInfo': 'aListOfCPDistributedObjectInfo',
    'List_CPGroupId': 'aListOfCPGroupId',
