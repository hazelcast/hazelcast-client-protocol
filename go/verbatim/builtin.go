...
func (entryListIntegerIntegerCodec) EncodeListInteger(message *proto.ClientMessage, entries []proto.Pair) {
...
func (mapCodec) EncodeForEndpointQualifierAndAddress(message *proto.ClientMessage, values map[proto.EndpointQualifier]proto.Address) {
	message.AddFrame(proto.BeginFrame.Copy())
	for key, value := range values {
