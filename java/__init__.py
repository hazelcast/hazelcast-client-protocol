...
_java_types_encode = {
    ...
    "EntryList_Long_Schema": "java.util.Collection<java.util.Map.Entry<Long, com.hazelcast.internal.serialization.impl.compact.Schema>>"
}
...
_java_types_decode = {
    ...
    "EntryList_Long_Schema": "java.util.List<java.util.Map.Entry<Long, com.hazelcast.internal.serialization.impl.compact.Schema>>"
}
